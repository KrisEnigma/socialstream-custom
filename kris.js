(function() {
    ...
    link.rel = 'stylesheet';
    link.href = 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/kris.css';
    ...
    Object.defineProperty(HTMLImageElement.prototype, 'src', {
        set: function(value) {
            if (value && value.includes('socialstream.ninja/sources/images/twitch.png')) {
                ...
                originalSrcDescriptor.set.call(this, 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/twitchbg.png');
            } else {
    ...
    function replaceTwitchIcons() {
        ...
        icons.forEach(img => {
            img.src = 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/twitchbg.png';
        });
    }
            ...
            mutation.addedNodes.forEach(function(node) {
                if (node.nodeType === 1) { // Element node
                    if (node.tagName === 'IMG' && node.src && node.src.includes('socialstream.ninja/sources/images/twitch.png')) {
                        ...
                        node.src = 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/twitchbg.png';
                    }
